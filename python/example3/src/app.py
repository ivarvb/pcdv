...
Exemplo: Digit Recognizer 
URL (problema): https://www.kaggle.com/c/digit-recognizer
URL (solução): https://www.kaggle.com/ivarvb/digit-recognizer
...
train = pd.read_csv(zf.open('input/3/train.csv'))
test = pd.read_csv(zf.open('input/3/test.csv'))
...
===================================================
"""
train.insert(0, 'ImageId', range(1, len(train)+1))
test.insert(0, 'ImageId', range(1, len(test)+1))
...
"""
===================================================
3. Classificação (aprendizagem supervisionado):
===================================================
